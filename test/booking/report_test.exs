defmodule Flightex.Bookings.ReportTest do
  ...
  describe "create/2" do
    test "generate report file according to the time range" do
      ...
      expected_response =
        "b5d6bd96-76de-4ced-bce1-535d6d558c49,Lisboa,Londres,2020-04-09 11:19:00\n" <>
          "b5d6bd96-76de-4ced-bce1-535d6d558c49,Luanda,Porto Alegre,2020-03-04 10:09:00\n"
